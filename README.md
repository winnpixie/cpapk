...
* Run `cd /sdcard`
* (This is a one-time step) Run `curl -O https://winnpixie.github.io/cpapk/cpapk.sh` to download the executable
...
* Running through Termux on a non-rooted device may not work for non-System apps and could require an app from the Play Store.
